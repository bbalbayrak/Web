...
const Certificate = {
  ...
  create: async (work_id, certificate_url, product_id, step_id) => {
    const result = await db.one(
      `INSERT INTO ${Certificate.tableName} (work_id, certificate_url, product_id, step_id) VALUES ($1, $2, $3, $4) RETURNING *`,
      [work_id, certificate_url, product_id, step_id]
    );
    return result;
  },
